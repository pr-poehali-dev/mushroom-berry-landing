...
const products = [
  ...
  },
  {
    ...
    desc: "Настоянное на лучших сушеных боровиках. Идеально для заправки салатов, пасты или просто для макания свежего хлеба.",
    price: 450,
    volume: "150 мл",
    emoji: "🫙",
    tag: "Новинка",
    image: "https://cdn.poehali.dev/projects/071e3c4d-3264-4929-b5b1-c82e7521c464/bucket/a724e89c-77f3-478d-9fe0-f75af21cae12.png",
  },
  {
    id: 3,
    name: "Грибная аджика «Огонёк»",
    desc: "Пикантная, ароматная, с вешенками и томлёными овощами. Заменит привычный кетчуп и станет звездой шашлыков.",
    price: 320,
    volume: "200 г",
    emoji: "🌶️",
    tag: null,
  ...
  {
    id: 4,
    name: "Чайный сбор «Лесная аптека»",
    desc: "Травы, ягоды и душистые растения Кировской области. Согревает, укрепляет иммунитет и пахнет русским лесом.",
    price: 250,
    volume: "50 г",
    emoji: "🌿",
    tag: null,
  },
  {
    id: 5,
    name: "Грибные цукаты",
    desc: "Натуральные сладости без сахара. Хрустящие кусочки вешенок в сиропе манго. Полезный перекус для детей и взрослых.",
    price: 350,
    volume: "100 г",
    emoji: "✨",
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                ...
                >
                  Мы — семья<br />
                  <em style={{ color: "var(--terra-light)" }}>Елизаровых</em>
                </h2>
                <div className="space-y-4 text-base leading-relaxed" style={{ color: "rgba(245,239,230,0.78)" }}>
                  <p>
                    Для нас лес — это не просто место тишины, это наша кладовая, которую мы знаем уже 15 лет. Мы не просто собираем грибы — мы создаём авторскую гастрономию, чтобы показать, что дары Вятского края могут звучать по-новому.
                  </p>
                  <p>
                    Варенье из чёрных лисичек? Грибная аджика? Это не экзотика — это вкус, который вы полюбите с первой ложки.
                  </p>
                </div>
              </div>
            </Reveal>

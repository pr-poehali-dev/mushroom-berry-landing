            ...
            <Reveal>
              <div>
                ...
                <div className="space-y-5">
                  ...
                  {/* WhatsApp */}
                  <a
                    href="https://wa.me/79513546447"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-6 flex items-center justify-center gap-3 w-full py-3.5 rounded-xl font-semibold text-sm transition-all hover:opacity-90 hover:scale-[1.01]"
